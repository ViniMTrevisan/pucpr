...
public class ConsultaUI extends Stage {
    ...
    private GridPane criarFormulario() {
        ...
        grid.add(campoNomePaciente, 1, 0);

        grid.add(new Label("Médico:"), 2, 0);     
        grid.add(campoNomeMedico, 3, 0);

        grid.add(new Label("Data/Hora:"), 0, 1);   
        grid.add(campoDataHora, 1, 1);

        grid.add(new Label("Valor (R$):"), 2, 1);  
        grid.add(campoValor, 3, 1);
